<div id="dealer-modal" tabindex="-1" wire:ignore.self
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                ...
                <form class="space-y-4" wire:submit.prevent="createDealer" wire:loading.remove>
                    <div>
                        <input wire:model.defer="input.dealer" type="text" name="dealer" id="dealer"
                            class="
                            @error('dealer')
                    ...
                    <div>
                        <input wire:model.defer="input.email" type="email" name="email" id="email"
                            class="
                            @error('email')
                    ...
                    <div>
                        <input wire:model.defer="input.phone" type="tel" name="phone" id="phone"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            placeholder="09*********">
                    </div>
                    <div>
                        <input wire:model.defer="input.address" type="text" name="address" id="address"
                    ...
                    <div>
                        <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                            password</label>
                        <input wire:model.defer="input.password" type="password" name="password" id="password"
                            placeholder="••••••••"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            required>
                    </div>
