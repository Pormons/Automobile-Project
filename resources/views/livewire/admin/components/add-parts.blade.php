<div id="parts-modal" tabindex="-1" wire:ignore.self
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                ...
                <form class="space-y-4" wire:submit.prevent="createPart" wire:loading.remove>
                    <div>
                        <input wire:model.defer="input.part_name" type="text" name="dealer" id="dealer"
                            class="
                            @error('part_name')
                    ...
                    <div>
                        <select id="countries" wire:model.defer="input.part_type"
