                    ...
                    <div class="w-full md:w-[50%] flex flex-row space-x-2">
                        <div class="flex flex-row-reverse border-2 rounded-lg pr-2">
                            ...
                            <input
                                ...
                                wire:model.live.500ms="searchTransaction" id="simple-search" name="simple-search"
                        ...
                        <tbody>
                            @foreach ($transactions as $key => $transaction)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">{{ $transaction->customer_info->first_name }}
                                    </td>
                                    ...
                                    <td class="px-4 py-3 flex">
                                        ...
                                        <div id="dropdownDots{{ $key }}"
                                            ...
                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                                                @if ($transaction->status === 'sold' || $transaction->status === 'Rejected' || $transaction->status === 'Pending')
                                                    <li>
                                                        <a href="/Dealer/Transactions/{{ $transaction->transaction_id }}"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Details</a>
                                                    </li>

                                                    @if ($transaction->status === 'Pending')
                                                        <li>
                                                            <a href="#" wire:click='confirmSold("{{ $transaction->transaction_id }}")'
                                                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Confirm Sold</a>
                                                        </li>
                                                    @endif
                                                @endif
                                            </ul>
